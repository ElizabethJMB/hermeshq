...
def upgrade() -> None:
    ...
    if "public_chat_api_keys" not in existing_tables:
        op.create_table(
    ...
    if "public_chat_sessions" not in existing_tables:
        op.create_table(
    ...
    if "public_chat_messages" not in existing_tables:
        op.create_table(
    ...
    if "public_chat_transcripts" not in existing_tables:
        op.create_table(
