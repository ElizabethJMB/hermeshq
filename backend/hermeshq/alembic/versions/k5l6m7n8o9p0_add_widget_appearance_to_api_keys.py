...
def upgrade() -> None:
    ...
    op.add_column("public_chat_api_keys", sa.Column("widget_theme", sa.String(10), server_default="auto", nullable=False))
    op.add_column("public_chat_api_keys", sa.Column("widget_accent", sa.String(10), server_default="#6366f1", nullable=False))
    op.add_column("public_chat_api_keys", sa.Column("widget_position", sa.String(10), server_default="right", nullable=False))
